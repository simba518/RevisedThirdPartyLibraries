...
void
cgstrf (char *refact, SuperMatrix *A, float diag_pivot_thresh, 
 ...
 */
    ...
    *info = cLUMemInit(refact, work, lwork, m, n, Astore->nnz,
	...
	if ( relax_end[jcol] != EMPTY ) { /* start of a relaxed snode */
		...
		xusub[icol+1] = nextu;
	        ...
	        csnode_bmod(icol, jsupno, fsupc, dense, tempv, &Glu);
    ...
    *info = iinfo;
	...
	((NCformat *)U->Store)->colptr = Glu.xusub;
        ...
        cCreate_SuperNode_Matrix(L, A->nrow, A->ncol, nnzL, Glu.lusup, 
